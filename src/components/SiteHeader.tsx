      ...
      <div className="mx-auto flex max-w-site items-center justify-between gap-4 px-4 py-3 sm:px-6">
        <Link href={routes.home} className="flex items-center gap-2.5">
          <span
            className={`inline-flex h-9 w-9 items-center justify-center rounded-sm ${
              overlay ? "bg-paper-50 text-navy" : "bg-navy text-paper-50"
            }`}
          >
            <svg
              viewBox="0 0 24 24"
        ...
        <nav className="hidden items-center gap-8 lg:flex" aria-label="Primary">
          ...
          <a
            ...
            className={`text-sm font-medium ${
              overlay ? "text-paper-200 hover:text-paper-50" : "text-ink-muted hover:text-navy"
            }`}
          >
            {brand.phoneDisplay}
          </a>
          <ButtonLink
            ...
            variant={overlay ? "inverseSolid" : "primary"}
          >
            Free Snapshot
          </ButtonLink>
        </nav>
