    ...
    <div>
      ...
      <div className="mx-auto max-w-site px-4 py-14 sm:px-6 sm:py-16">
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          />
          <div>
            <h2 className="font-serif text-3xl text-navy sm:text-4xl">Direct</h2>
            <div className="mt-6 space-y-4">
              ...
              <div className="card p-5">
                ...
                <p className="mt-1 text-ink-muted">
                  Gold Coast, Queensland. No shopfront. We talk by phone or
                  video, and I work with businesses anywhere in Australia. Around
                  the Gold Coast and Brisbane I can come to you.
                </p>
              </div>
            </div>
          </div>
