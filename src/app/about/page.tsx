  ...
  return (
    <div className="mx-auto max-w-site px-4 py-16 sm:px-6 sm:py-20">
      ...
      <div className="mt-12 grid gap-12 lg:grid-cols-[0.8fr_1.2fr]">
        ...
        <div>
          <h2 className="font-serif text-3xl text-navy">Why I run it this way</h2>
          <p className="mt-3 leading-relaxed text-ink-muted">
            Most SEO agencies work like this: a salesperson wins you over, an
            account manager keeps you calm, and someone you never meet does the
            work. Prices are hidden because they&apos;re set per client. Reports
            are long because they need to look like a lot happened.
          </p>
          <p className="mt-3 leading-relaxed text-ink-muted">
          ...
          <p className="mt-3 leading-relaxed text-ink-muted">
            So I run TakeoffSEO the other way. Every price is on the site. Every
            package is a checklist you can tick off. You talk to me, I do the
            work, and the report fits on one page.
          </p>
          ...
          <p className="mt-3 leading-relaxed text-ink-muted">
            ...
            like ChatGPT. That means your Google profile, your website, and your
            reviews. I don&apos;t do ads, social media, logos or
          ...
          <div className="mt-8 rounded-sm bg-paper-200/50 p-5 text-sm">
            <p>
